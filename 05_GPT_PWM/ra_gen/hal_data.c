...
gpt_instance_ctrl_t g_timer2_pwm_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer2_pwm_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer2_pwm_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg                   = &g_timer2_pwm_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 1
...
const timer_cfg_t g_timer2_pwm_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.001 seconds. Actual duty: 80%. */.period_counts = (uint32_t) 0x186a0,
  .duty_cycle_counts = 0x13880, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = timer2_pwm_callback,
...
const timer_instance_t g_timer2_pwm =
{ .p_ctrl = &g_timer2_pwm_ctrl, .p_cfg = &g_timer2_pwm_cfg, .p_api = &g_timer_on_gpt };
